$(document).ready(function () {
    ...
    $('#btn_save').click(function () {
        ...
        learn_tsc += learn_f ? "F" : "";
        learn_tsc += learn_tg ? "TG" : "";
        learn_tsc += learn_co ? "CO" : "";
        learn_tsc += learn_o ? "Oth" : "";

        console.log(learn_tsc);
        ...
        var learn_tsc = learn_tsc;
        var var_player = $('#var_player').val();
        var sport = $('#sport').val();
...
// "&learn_tsc=" + learn_tsc + "&sport=" + sport + "&degree=" + degree);

                if (result.isConfirmed) {
                    $.ajax({
                        url: "online_enrollmentGrade11.php",
                        type: "POST",
                        data: "ref_number=" + ref_num + "&fname=" + fname + "&mname=" + mname + "&lname=" + lname + "&dob=" + dob + "&pob=" + pob +
                            ...
                            "&fam_fname2=" + fam_fname2 + "&fam_mname2=" + fam_mname2 + "&fam_lname2=" + fam_lname2 +
                            "&fam_relationship2=" + fam_relationship2 + "&batch2=" + batch2 + "&fam_cont2=" + fam_cont2 +
                            "&learn_tsc=" + learn_tsc +  "&var_player=" + var_player +"&sport=" + sport + "&p_degree=" + p_degree +"&degree=" + degree,
